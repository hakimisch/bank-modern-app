...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
            ...
            <div className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[rgb(47,52,68)] ease-in-out duration-500'  : 'fixed left-[-100%]' }>
                <h1 className='w-full text-3xl font-bold text-[cyan] m-4'>REACT.</h1>
